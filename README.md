...
This repo contains two Python scripts for running a **Protrec2** workflow on HeLa data as an example and producing protein-level existence probabilities.

| file                  | purpose                                                                                                                                                                                                                             |
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`complex_data.py`** | Loads/cleans complex resources. Exposes four ready-to-use objects:<br> • `complex_list`, `initial_prob` – short complexes<br> • `complex_list1`, `initial_prob1` – full complex catalogue              |
